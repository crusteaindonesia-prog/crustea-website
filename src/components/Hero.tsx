          ...
          <ScrollAnimationWrapper className="w-full lg:w-1/2">
            ...
            >
              ...
              <p className="font-sans text-[17px] pt-3 text-justify lg:text-left lg:pt-10 text-black-600">
                Driven by the concerns of Indonesian pond farmers who struggle
                with high operational Our goal is to empower farmers to achieve
                the best possible outcomes in terms of quantity and quality in
                aquaculture production while making a direct contribution to
