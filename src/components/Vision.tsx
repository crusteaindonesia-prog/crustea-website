        ...
        <div className="flex flex-wrap lg:h-72 md:mt-40">
          ...
          >
            ...
            >
              <div className="bg-[#ACCB37] h-full lg:h-full w-full mix-blend-multiply">
                <h2 className="text-white-300 h-full lg:h-full font-bold mx-auto mix-blend-normal flex items-center justify-center text-3xl lg:text-6xl">
                  OUR VISION
                </h2>
              </div>
            </div>
          ...
          >
            <div className="bg-[#DEE8DB] lg:py-16 h-32 w-full lg:h-72">
              <p className="text-xl text-[#000000] h-full lg:text-3xl max-w-xl mx-5 sm:mx-10 md:mx-auto text-center font-medium flex items-center lg:leading-[48px] md:justify-center italic lg:text-right lg:mr-16">
