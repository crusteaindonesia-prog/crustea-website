...
const Article: React.FC = () => {
  ...
  return (
    <>
      ...
      <div className="md:mx-28 shadow-xl lg:px-24 lg:py-14 md:mt-20">
        <Link to={"/"}>
        ...
        <div>
          <h2 className="font-DMSans font-medium md:font-bold text-2xl md:text-4xl">
            {blog.title}
          </h2>
          <p className="font-normal text-black-600 text-xl md:text-3xl">
            {blog.desc}
          </p>
