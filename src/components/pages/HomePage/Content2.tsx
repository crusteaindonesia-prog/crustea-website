    ...
    <section className="relative bg-[#F3F8E9] py-16 px-4 md:px-10 overflow-hidden">
      ...
      <div className="relative z-10 max-w-screen-xl mx-auto text-center">
        ...
        <h2 className="text-2xl sm:text-3xl font-bold text-[#08556b] mb-2">
          {t("content2.heading")} {/* Terjemahkan judul utama */}
        </h2>
        <p className="text-gray-600 text-sm mb-10">
          {t("content2.subtitle")} {/* Terjemahkan subtitle */}
        </p>
        ...
        <div className="flex flex-col md:flex-row items-center justify-center gap-8">
          ...
          <div className="bg-white/90 backdrop-blur-sm rounded-lg shadow-md p-6 w-full md:w-1/3">
            <h3 className="text-3xl font-bold text-[#9BCB3C] mb-4">
              {t("content2.year_2020")} {/* Terjemahkan tahun 2020 */}
            </h3>
            <ul className="text-left text-[#08556b] text-sm space-y-2">
              <li>• {t("content2.2020_item1")}</li>{" "}
              {/* Terjemahkan item 1 tahun 2020 */}
              <li>• {t("content2.2020_item2")}</li>{" "}
              {/* Terjemahkan item 2 tahun 2020 */}
            </ul>
          </div>
          ...
          <div className="bg-white/90 backdrop-blur-sm rounded-lg shadow-md p-6 w-full md:w-1/3">
            <h3 className="text-3xl font-bold text-[#9BCB3C] mb-4">
              {t("content2.year_2025")} {/* Terjemahkan tahun 2025 */}
            </h3>
            <ul className="text-left text-[#08556b] text-sm space-y-2">
              <li>
                • <strong>{t("content2.2025_item1")}</strong>
              </li>{" "}
              {/* Terjemahkan item 1 tahun 2025 */}
              <li>
                • <strong>{t("content2.2025_item2")}</strong>
              </li>{" "}
              {/* Terjemahkan item 2 tahun 2025 */}
            </ul>
          </div>
        </div>
      </div>
